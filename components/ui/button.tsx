  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-sm text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        destructive:
          'bg-black text-white shadow-xs hover:bg-black/90 focus-visible:ring-black/20 dark:focus-visible:ring-white/40 dark:bg-white dark:text-black',
        outline:
          'border bg-background shadow-xs hover:bg-accent hover:text-accent-foreground dark:bg-input/30 dark:border-input dark:hover:bg-input/50',
        secondary:
          'bg-secondary text-secondary-foreground shadow-xs hover:bg-secondary/80',
        ghost: 'hover:text-red-500 dark:hover:bg-accent/50 cursor-pointer',
        link: 'text-primary underline-offset-4 hover:underline',
        play: 'bg-accent/50 cursor-pointer hover:text-red-500 hover:border-red-500',
      },
      size: {
        default: 'h-9 px-4 py-2 has-[>svg]:px-3',
        sm: 'h-8 rounded-sm gap-1.5 px-3 has-[>svg]:px-0.5',
        lg: 'h-10 rounded-sm px-6 has-[>svg]:px-4',
        play: 'w-8 h-6 rounded-sm gap-1.5 px-3',
      },
    },
    defaultVariants: {
      variant: 'default',
